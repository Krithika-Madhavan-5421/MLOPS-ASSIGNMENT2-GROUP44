...
2. 3. CI Setup (Choose one: GitHub Actions / GitLab CI / Jenkins / Tekton)
...
Artifact Publishing: Configure the pipeline to push the Docker image to a container registry
